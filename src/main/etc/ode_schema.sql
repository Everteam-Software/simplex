...
create table BPEL_RES_ROUTE (ID bigint not null auto_increment, URL varchar(255) not null, METHOD varchar(255) not null, CHANNEL varchar(255) not null, CHAN_IDX integer not null, PIID bigint, INSERT_TIME datetime, MLOCK integer not null, primary key (ID)) TYPE=InnoDB;
